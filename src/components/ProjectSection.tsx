...
const projects = [
  {
    ...
    description: "A dynamic e-commerce platform built with React and Node.js, featuring real-time inventory management and secure payment processing for a smooth shopping experience.",
  ...
  },
  {
    ...
    description: "A real-time chat application built using Node.js, WebSocket, and MongoDB with end-to-end encryption and file sharing capabilities for efficient communication.",
  ...
  },
  {
    ...
    description: "A comprehensive project management tool with team collaboration features, built with Vue.js and Express.js backend for enhanced productivity.",
  ...
  <section id="projects" className="py-24 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full px-6 py-3 mb-8">
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tags.map((tag, tagIndex) => (
                      <span 
                        key={tag} 
                        className={`bg-gradient-to-r ${tagIndex % 3 === 0 ? 'from-blue-900/50 to-purple-900/50 text-blue-300 border border-blue-500/20' : tagIndex % 3 === 1 ? 'from-cyan-900/50 to-blue-900/50 text-cyan-300 border border-cyan-500/20' : 'from-purple-900/50 to-pink-900/50 text-purple-300 border border-purple-500/20'} px-4 py-2 rounded-full text-xs font-bold`}
                      >
                        {tag}
                      </span>
                    ))}
