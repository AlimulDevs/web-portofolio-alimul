        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in-left">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full px-6 py-3">
              ...
              <div className="flex flex-wrap gap-3 pt-6">
                {['Problem Solver', 'Clean Code Advocate', 'Tech Innovator', 'Continuous Learner'].map((skill, index) => (
                  <span 
                    key={skill} 
                    className={`bg-gradient-to-r ${index % 2 === 0 ? 'from-blue-500 to-purple-500' : 'from-cyan-500 to-blue-500'} text-white px-6 py-3 rounded-full text-sm font-bold hover:scale-105 transition-transform duration-200 cursor-default`}
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="relative animate-fade-in-right">
              <div className="relative bg-gradient-to-br from-blue-500 via-purple-500 to-cyan-500 rounded-3xl p-2 transform hover:rotate-2 transition-transform duration-300">
                <div className="bg-gray-800 rounded-2xl p-8 space-y-6">
                  <div className="flex items-center justify-center">
                    <div className="w-32 h-32 bg-gradient-to-br from-blue-500 via-purple-500 to-cyan-500 rounded-full flex items-center justify-center text-4xl font-black text-white">
                      NAH
                    </div>
                  </div>
