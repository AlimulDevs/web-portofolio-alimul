...
const HeroSection = ({ isVisible }: HeroProps) => {
  ...
  return (
    ...
    >
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-blue-900 to-blue-900 animate-gradient-xy">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-blue-500/10 rounded-lg animate-float-delayed flex items-center justify-center">
      ...
      >
        ...
        <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black text-white mb-8 leading-tight" data-aos="fade-up">
          Hi, I'm
          <span className="block bg-gradient-to-r from-blue-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">
            Nur Alimul Haq
          </span>
        </h1>

        <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed " data-aos="fade-down">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="group bg-gradient-to-r from-green-600 to-blue-600 text-white px-10 py-4 rounded-full font-bold hover:from-blue-600 hover:to-blue-700 transition-all duration-300 hover:scale-110 shadow-2xl flex items-center space-x-2"
          data-aos="fade-right"
         >
